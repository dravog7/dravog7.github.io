...
(function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(span, file$1, 5, 4, 223);
    			div.className = "flex m-auto text-center w-56 h-56 main svelte-1homwh8";
    			add_location(div, file$1, 4, 0, 166);
    		},
    ...
    /* src/components/navbar.svelte generated by Svelte v3.4.0 */
    ...
    onDestroy(async () => {
        document.body.classList.remove("construction");
    });
