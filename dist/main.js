    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			p0 = element("p");
    			p0.textContent = "When I first learned to code, I found myself capable of bringing life to ideas \n        without material expenses. I started by fulfilling my day to day needs and wants \n        by writing python scripts for organizing files, send files across networks, etc. \n        Later I sought out the needs of others around me. I made a search engine that \n        indexed television series video files and made browser extensions to simplify \n        tasks in a game.\n        ";
    			p1 = element("p");
    			p1.textContent = "Through these experiences, I learned about my passion to make software solutions \n        for myself and others. I am currently a freelance software developer specializing \n        in Python.";
    			attr_dev(h1, "class", "w-full font-bold text-4xl");
    			add_location(h1, file$2, 36, 4, 1093);
    			attr_dev(img, "class", "pic rounded-full w-48 svelte-ohit3m");
    			attr_dev(img, "alt", "github profile pic");
    			if (img.src !== (img_src_value = "https://avatars0.githubusercontent.com/u/31211464?s=460&u=04b83e4be0b137a36006d7d57e3e063a1d605ca8&v=4")) attr_dev(img, "src", img_src_value);
    			add_location(img, file$2, 39, 12, 1283);
    			attr_dev(div0, "class", "mx-auto rounded-full overflow-hidden");
    			add_location(div0, file$2, 38, 8, 1220);
    			attr_dev(p0, "class", "indented svelte-ohit3m");
    			add_location(p0, file$2, 47, 8, 1618);
    			attr_dev(p1, "class", "indented svelte-ohit3m");
    			add_location(p1, file$2, 54, 12, 2118);
    			attr_dev(div1, "class", "w-9/12 text-md m-auto text-justify flex flex-col");
    			add_location(div1, file$2, 37, 4, 1149);
    			attr_dev(div2, "id", "about");
    			attr_dev(div2, "class", "flex flex-col\n    w-11/12 min-h-screen mx-auto text-center py-24\n    rounded-lg\n    hover:shadow-md\n    transition-all duration-500 ease-in-out svelte-ohit3m");
    			add_location(div2, file$2, 29, 0, 919);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div0, img);
    			append_dev(div1, t2);
    			mount_component(quotes, div1, null);
    			append_dev(div1, t3);
    			append_dev(div1, p0);
    			append_dev(div1, p1);
    			current = true;
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$6, 29, 4, 1192);
    			attr_dev(div0, "class", "mx-auto w-11/12 flex-1");
    			add_location(div0, file$6, 30, 4, 1249);
    			attr_dev(div1, "id", "projects");
    			attr_dev(div1, "class", "flex flex-col bg-transparent w-screen h-screen py-24 grad-bg svelte-5kl3w5");
    			add_location(div1, file$6, 28, 0, 1099);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
